                                                        ...
                                                        <div class="row g-3 align-items-center">
                                                            ...
                                                            <div class="col-auto">
                                                                <p class="col-form-label">{{ ucwords(strtolower($att_level3->name)) ?? '-' }}
                                                                    ...
                                                                    @if ($att_level3->add)
                                                                        <input class="form-check-input rounded-circle fa fa-plus"
                                                                            {{ in_array($att_level3->code . '_create', $markMenuCodes) ? 'checked' : '' }} value="{{ $att_level3->code . '_create' }}"
                                                                            name="permissions[]" type="checkbox">
                                                                    @endif
                                                                    ...
                                                                    @if ($att_level3->delete)
                                                                        <input class="form-check-input rounded-circle fa fa-trash" type="checkbox"
                                                                            {{ in_array($att_level3->code . '_delete', $markMenuCodes) ? 'checked' : '' }} value="{{ $att_level3->code . '_delete' }}"
                                                                            name="permissions[]">
                                                                    @endif
