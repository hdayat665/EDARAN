            ...
            <div class="panel-body">
                    ...
                    <form>
                        <div class="row p-2">
                            <div class="col">
                                <div class="row p-2">
                                    <label for="submitClaim" class="col-sm-5 col-form-label">Submit Claim to Admin
                                        ...
                                        <i class="fa fa-question-circle" style="color:rgba(0, 81, 255, 0.904)"
                                            data-toggle="tooltipsubmitclaim"
                                ...
                                <br>
                                <div class="row p-2">
                                    <label for="expiredate" class="col-sm-5 col-form-label">Open Claim Duration <i
                                            class="fa fa-question-circle" style="color:rgba(0, 81, 255, 0.904)"
                                            data-toggle="tooltipexpiredate"
                                            title="User can decide duration to open claim 
                            "></i></label>
                                    <div class="col-sm-3">
                                        <select class="form-select" id="" name="status">
                                            <option class="form-label" value="">Please Select</option>
                            ...
                            <div class="col">
                                <div class="row p-2">
                                    <label for="claimfinance" class="col-sm-5 col-form-label">Submit Claim to
                                        Finance on Every: <i class="fa fa-question-circle"
                                            style="color:rgba(0, 81, 255, 0.904)" data-toggle="tooltipsubmitclaim"
                            ...
                            "></i></label>
                                ...
                                <div class="row p-2">
                                    <label for="claimsubmit" class="col-sm-5 col-form-label">Table List Display:
                                        <i class="fa fa-question-circle" style="color:rgba(0, 81, 255, 0.904)"
                                            data-toggle="tooltipclaimsubmit"
                ...
                <div class="row">
                    <div class="col align-self-start">
                        <a href="/setting" class="btn btn-light" style="color: black" type="submit" name=""
                            id=""><i class="fa fa-arrow-left"></i> Back</a>
                    </div>
                    <div class="col d-flex justify-content-end">
                        <button class="btn btn-light" type="submit" style="color: black" name=""
                            id=""><i class="fa fa-save"></i> Submit</button>
                    </div>
                </div>
                </form>
            </div>
