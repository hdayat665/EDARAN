...
@section('content')
                            ...
                            <div class="col mb-6">
                                <div class="row">
                                    <label for="localhotela" class="col-sm-3 col-form-label">Local Hotel
                                        Allowance</label>
                                    <div class="col-sm-3">
                                        <select class="form-select" name="localhotela" id="localhotela"
                                    ...
                                    <div class="col-sm-3" id="localhoteli" style="display: none">
                                        <input type="text" class="form-control" id="" name="localhotela"
                                            value="">
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    <label for="lodgingallowance" class="col-sm-3 col-form-label">Lodging
                                        Allowance</label>
                                    <div class="col-sm-3">
                                        <select class="form-select" name="lodgingallowance" id="lodgingallowance"
                                            aria-label="Disabled select example" id="lodginghotels">
                                            <option selected value="0">None</option>
                                            <option value="1">Actual</option>
                                            <option value="2">Input Value</option>
                                        </select>
                                    ...
                                    <div class="col-sm-3" id="lodginghoteli" style="display: none">
                                        <input type="text" class="form-control" id="local_hotela1" name=""
                                            value="">
                                    </div>
                                </div>
                                <br>
                            ...
                            <tr>
                                <td>
                                    <a href="javascript:;" data-toggle="modal" data-bs-toggle="modal"
                                        data-bs-target="#editsubsistence" class="btn btn-outline-blue"><i
                    ...
                    <table id="tableSaveArea" class="table table-striped table-bordered align-middle">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="javascript:;" data-toggle="modal" data-bs-toggle="modal"
                                        data-bs-target="#editclaimbenefit" class="btn btn-outline-blue"><i
                                            class="fa fa-edit"></i></a>
                                </td>
                                <td>ENTERTAINMENT</td>
                                <td></td>
    ...
    <div class="modal fade" id="editsubsistence" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
    ...
    {{-- modal claim --}}
    <div class="modal fade" id="editclaimbenefit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
