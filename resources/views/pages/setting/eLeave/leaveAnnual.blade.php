...
@section('content')
    ...
    <div id="content" class="app-content">
        <!-- END breadcrumb -->
        <!-- BEGIN page-header -->
        <h1 class="page-header" id="eleaveentitlementJs">Setting | Leave Entitlements</h1>
        <div class="row">
            <div class="col-xl-15" id="">
                <!-- BEGIN nav-tabs -->
                ...
                <div class="tab-pane fade" id="default-tab-2">   
                    ...
                    <div class="panel-body">
                        <table  id="tablesick"  class="table table-striped table-bordered align-middle">
                            <thead>
                                <tr>	
                                <th class="text-nowrap">No.</th>
                                <th class="text-nowrap">Job Grade</th>
