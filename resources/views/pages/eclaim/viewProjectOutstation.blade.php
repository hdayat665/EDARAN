    ...
    <div class="col-md-7">
        <div class="form-control">
            ...
            <div class="row p-2">
                ...
                <div class="col-md-9">
                    <input readonly type="text" class="form-control" name="cash['type']" value="{{ getCashAdvanceType($cashClaim->type) }}">
                </div>
            </div>
            <div class="row p-2">
                <div class="col-md-3">
            ...
            <div class="row p-2">
                ...
                <div class="col-md-9">
                    <input readonly type="text" class="form-control" name="mot['transport_type']" value="{{ getModeOfTransport($cashClaim->mode_of_transport->tranport_type) }}">
                </div>
            </div>
            <div class="row p-2">
                <div class="col-md-3">
                ...
                <div class="col-md-9">
                    <input readonly type="text" class="form-control" name="cash['travel_date']" value="{{ $cashClaim->travel_date }}">
                </div>
            </div>
            <div class="row p-2">
                <div class="col-md-3">
                ...
                <div class="col-md-9">
                    <input readonly type="text" class="form-control" name="cash['project_id']" value="{{ getProjectById($cashClaim->project_id)->project_name }}">
                </div>
            </div>
            <div class="row p-2">
                <div class="col-md-3">
    ...
    <div class="panel panel" id="">
        <div class="panel-body">
            <div class="row p-2">
                ...
                <div class="col-md-2">
                    <div class="row p-2"> 
                        <button type="button" class="btn btn-primary hide-on-print" id="printButton1">Print</button>
                    </div>
                </div>
                <style>
                    @media print{
