...
@section('content')
    <div id="content" class="app-content">
        <h1 class="page-header">eClaim | Claim Approval | Admin Checker</h1>
        <div class="panel panel" id="adminCheckerJs">
            <div class="panel-body">
                ...
                <div class="form-control">
                    ...
                    <div class="tab-content panel p-3 rounded">
                        @include('pages.eclaim.claimApproval.admin.checker.tab1')
                        @include('pages.eclaim.claimApproval.admin.checker.tab2')
                        @include('pages.eclaim.claimApproval.admin.checker.tab3')
                        @include('pages.eclaim.claimApproval.admin.checker.tab4')
                    </div>
                </div>
            </div>
        </div>
    ...
    @include('modal.eclaimApproval.adminCheckerModal')
@endsection
