        ...
        <div class="panel panel" id="adminCheckerMtcJs">
            ...
            <div class="row p-2">
                ...
                <div class="col-md-2">
                    ...
                    <div class="row p-2">
                        <div class="col d-flex justify-content-end">
                            <a href="/adminCheckerView" class="btn btn-light" style="color: black; width:60%" type="submit"><i class="fa fa-arrow-left"></i> Back</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row p-2">
                <div class="col-md-12">
                    <div class="form-control">
                        ...
                        @include('pages.eclaim.tableAdminChecker')
                    </div>
                </div>
            </div>
