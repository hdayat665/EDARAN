    ...
    <table id="rejectedtable" class="table table-striped table-bordered align-middle">
        ...
        <tbody>
            ...
            @foreach ($claims as $claim)
                @if ($claim->a_approval == 'reject' && $claim->claim_type == 'MTC')
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a href="javascript:;" id="rejectModalButton3" data-id="{{ $claim->id }}" class="dropdown-item" data-bs-toggle="modal"><i class="fa fa-ban" aria-hidden="true"></i>
                                    Reject</a>
                                <div class="dropdown-divider"></div>
                                <a href="javascript:;" id="amendModalButton3" data-id="{{ $claim->id }}" class="dropdown-item" data-bs-toggle="modal"><i class="fa fa-reply" aria-hidden="true"></i>
                                    Amend</a>
                                <div class="dropdown-divider"></div>
