...
@section('content')
    <div id="content" class="app-content">
        <h1 class="page-header">eClaim | Claim Approval | Admin Approver</h1>
        <div class="panel panel" id="adminApprovalJs">
            <div class="panel-body">
                ...
                <div class="form-control">
                            ...
                            <div class="row">
                                <div class="col d-flex justify-content-start">
                                    <ul class="nav nav-pills">
                                        ...
                                        <li class="nav-item">
                                            <a href="#default-tab-3" data-bs-toggle="tab" class="nav-link " id="rejectedTab">Rejected</a>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div class="tab-content panel p-3 rounded">
                        @include('pages.eclaim.claimApproval.admin.approval.tab1')
    ...
    @include('modal.eclaimApproval.adminApprovalModal')
@endsection
