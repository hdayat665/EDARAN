<div class="tab-pane fade show" id="default-tab-4">
    <table id="tabletable" class="table table-striped table-bordered align-middle">
        <thead>
            <tr>
        ...
        <tbody>
            @if ($claims)
                @foreach ($claims as $claim)
                    @if ($claim->a_approval == 'amend' && $claim->claim_type == 'MTC')
                        <tr>
                        <td style="text-align: center"><input class="form-check-input" type="checkbox" />
                            <td>
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <div class="dropdown-divider"></div>
                                    <a href="javascript:;" id="rejectModalButton4" data-id="{{ $claim->id }}" class="dropdown-item" data-bs-toggle="modal"><i class="fa fa-ban"
                                            aria-hidden="true"></i>
                                        Reject</a>
                                    <div class="dropdown-divider"></div>
                                    <a href="javascript:;" id="amendModalButton4" data-id="{{ $claim->id }}" class="dropdown-item" data-bs-toggle="modal"><i class="fa fa-reply"
                                            aria-hidden="true"></i>
                                        Amend</a>
                                    <div class="dropdown-divider"></div>
