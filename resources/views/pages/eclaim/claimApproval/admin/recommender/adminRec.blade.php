            ...
            <div class="panel-body">
                ...
                <div class="form-control">
                    ...
                    <div class="tab-content panel p-3 rounded">
                        @include('pages.eclaim.claimApproval.admin.recommender.tab1')
                        @include('pages.eclaim.claimApproval.admin.recommender.tab2')
                        @include('pages.eclaim.claimApproval.admin.recommender.tab3')
                        @include('pages.eclaim.claimApproval.admin.recommender.tab4')
                    </div>
                </div>
            </div>
        </div>
    </div>
    @include('modal.eclaimApproval.adminRecModal')
@endsection
