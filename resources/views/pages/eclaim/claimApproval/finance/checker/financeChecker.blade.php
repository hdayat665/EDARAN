            ...
            <div class="panel-body">
                ...
                <div class="form-control">
                    ...
                    <div class="tab-content panel p-3 rounded">
                        ...
                        @include('pages.eclaim.claimApproval.finance.checker.fcTab4')
                        @include('pages.eclaim.claimApproval.finance.checker.fcTab5')
                        @include('pages.eclaim.claimApproval.finance.checker.fcTab6')
                        @include('pages.eclaim.claimApproval.finance.checker.fcTab7')
                    </div>
                </div>
            </div>
        </div>
    </div>
    @include('modal.eclaimApproval.fcheckerModal')
@endsection
