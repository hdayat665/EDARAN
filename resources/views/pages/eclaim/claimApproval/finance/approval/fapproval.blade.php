...
@section('content')
    <div id="content" class="app-content">
        <h1 class="page-header">eClaim | Claim Approval | Finance Approver</h1>
        <div class="panel panel" id="fapprovalJs">
            <div class="panel-body">
                ...
                <div class="form-control">
                    ...
                    <div class="tab-content panel p-3 rounded">
                        @include('pages.eclaim.claimApproval.finance.approval.tab1')
                        @include('pages.eclaim.claimApproval.finance.approval.tab2')
                        @include('pages.eclaim.claimApproval.finance.approval.tab3')
                        @include('pages.eclaim.claimApproval.finance.approval.tab4')
                        @include('pages.eclaim.claimApproval.finance.approval.tab5')
                    </div>
                </div>
            </div>
        </div>
    </div>
    @include('modal.eclaimApproval.fapprovalModal')
@endsection
