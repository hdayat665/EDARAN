            ...
            @if ($domain->approver == Auth::user()->id)
                @foreach ($claims as $claim)
                    @if (isset($config->status))
                        @if ($claim->f_recommender == 'recommend' && ($claim->f_approval == '' || $claim->f_approval == null))
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown-menu">
                                        @if ($claim->claim_type == 'MTC')
                                            <a href="/financeAppDetailClaimView/{{ $claim->id }}" id=""
                                                data-id="" class="dropdown-item"><i class="fa fa-eye"
