...
@section('content')
    <div id="content" class="app-content">
        <h1 class="page-header">eClaim | Claim Approval | Finance Recommender</h1>
            ...
            <div class="panel-body">
                ...
                <div class="form-control">
                    ...
                    <div class="tab-content panel p-3 rounded">
                        ...
                        @include('pages.eclaim.claimApproval.finance.recommender.tab3')
                        @include('pages.eclaim.claimApproval.finance.recommender.tab4')
                    </div>
                </div>
            </div>
        </div>
    </div>
    @include('modal.eclaimApproval.frecModal')
@endsection
