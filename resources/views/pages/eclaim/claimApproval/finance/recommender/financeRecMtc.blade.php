...
@section('content')
    <div id="content" class="app-content">
        ...
        <div class="panel panel" id="financeRecMtcJs">
            <!-- NEW DESIGN -->
            {{-- ROW 1 --}}
            <div class="row p-2">
            <div class="col-md-5">
                ...
                <div class="col-md-2">
                    @php
                        $allChecked = $travelClaims->every(function ($item) {
                            return $item->financerec === 'checked';
                        });
                    @endphp
                    ...
                    <div class="row p-2">
                        <div class="col d-flex justify-content-end">
                            <a href="/financeRecView" class="btn btn-light" style="color: black;width:100%" type="submit"><i class="fa fa-arrow-left"></i> Back</a>
                        </div>
                    </div>
                    @else
                    <div class="row p-2">
            ...
            <div class="row p-2">
                <div class="col-md-12">
                    <div class="form-control">
                        ...
                        @include('pages.eclaim.tableFinRec')
                    </div>
                </div>
            </div>
        </div>
