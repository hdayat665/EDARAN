                            ...
                            @if ($claim->f1 == 'recommend' && $claim->f_recommender == '')
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            @if ($claim->claim_type == 'MTC')
                                                <a href="/financeRecDetailClaimView/{{ $claim->id }}" id=""
                                    ...
                                    @if ($claim->status == 'amend')
                                        <td><span class="badge bg-warning" data-toggle="amendc"
                                                title="Amend">Amend</span>
                                        </td>
                                    ...
                                    @elseif ($claim->status == 'draft')
                                        <td><span class="badge bg-warning" data-toggle="drafc"
                                                title="Draft">Draft</span>
                                        </td>
