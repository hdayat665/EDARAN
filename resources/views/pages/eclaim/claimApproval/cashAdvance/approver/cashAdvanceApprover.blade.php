                ...
                <div class="form-control">
                    ...
                    <div class="form-control">
                        ...
                        <div class="tab-content panel p-3 rounded">
                            @include('pages.eclaim.claimApproval.cashAdvance.approver.tab1')
                            @include('pages.eclaim.claimApproval.cashAdvance.approver.tab2')
                            @include('pages.eclaim.claimApproval.cashAdvance.approver.tab3')
                            @include('pages.eclaim.claimApproval.cashAdvance.approver.tab4')
                        </div>
                    </div>
                </div>
            </div>
