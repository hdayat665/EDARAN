...
@section('content')
    <div id="content" class="app-content">
        ...
        <!-- END breadcrumb -->
        <!-- BEGIN page-header -->
        <h1 class="page-header">eClaim | Cash Advance Approval | Finance Approver</h1>
        <div class="panel panel" id="financeApprocerCaJs">
                ...
                <div class="form-control">
                    ...
                    <div class="form-control">
                        ...
                        <div class="tab-content panel p-3 rounded">
                            @include('pages.eclaim.claimApproval.cashAdvance.finance.approver.tab1')
                            @include('pages.eclaim.claimApproval.cashAdvance.finance.approver.tab2')
                            @include('pages.eclaim.claimApproval.cashAdvance.finance.approver.tab3')
                            @include('pages.eclaim.claimApproval.cashAdvance.finance.approver.tab4')
                            @include('pages.eclaim.claimApproval.cashAdvance.finance.approver.tab5')
                        </div>
