...
@section('content')
    {{-- <div id="content" class="app-content">
        <h1 class="page-header">eClaim <small>| Finance Approver | View Cash Advance | Others ( Non-Outstation )</small></h1>
        <div class="panel panel" id="fapprovalCaJs">
            ...
            <div class="row p-2">
                ...
                @if ($ca->f_approver == 'recommend')
                    ...
                    <a class="btn btn-lime" id="f_approver_button3" data-id="{{ $ca->id }}" style="color: black" type="submit"> Approve</a>
                    @endif 
                </div> --}}
            {{-- </div>
        </div>
                ...
                <div class="row p-2">
                    ...
                    <div class="col-md-2">
                            <div class="row p-2"> 
                                ...
                                @if ($ca->f_approver == 'recommend')
                                <a href="/cashAdvanceFapproverView" class="btn btn-light" style="color: black;" type="submit"> Back</a>
                                @elseif ($ca->f_approver == 'reject')
                                <a href="/cashAdvanceFapproverView" class="btn btn-light" style="color: black;" type="submit"> Back</a>
                                @else
