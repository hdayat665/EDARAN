...
@section('content')
    <div id="content" class="app-content">
        <h1 class="page-header">eClaim <small>| Finance Approver | View Cash Advance | Others ( Outstation )</small></h1>
        <div class="panel panel" id="projectOutsideJs">
                    ...
                    <div class="col-md-7">
                        <div class="form-control">
                            ...
                            <div class="row p-2">
                                ...
                                <div class="col-md-9">
                                    <input readonly type="text" class="form-control" value="MYR {{ getModeOfTransport($ca->mode_of_transport->tranport_type) }}">
                                </div>
                            </div>
                            <div class="row p-2">
                                <div class="col-md-3">
                            ...
                            <div class="row p-2">
                                ...
                                <div class="col-md-9">
                                    <input readonly type="text" class="form-control" value="MYR {{ $ca->destination ?? '-' }}">
                                </div>
                            </div>
                            <div class="row p-2">
                                <div class="col-md-3">
            ...
            <div class="row p-2">
                ...
                @if ($ca->f_approver == 'recommend')
                    ...
                    <a class="btn btn-lime" id="f_approver_button2" data-id="{{ $ca->id }}" style="color: black" type="submit"> Approve</a>
                    @endif 
                </div>
            </div>
        </div>
