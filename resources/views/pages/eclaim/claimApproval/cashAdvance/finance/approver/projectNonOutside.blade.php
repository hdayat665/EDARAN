...
@section('content')
    {{-- <div id="content" class="app-content">
        <h1 class="page-header">eClaim <small>| Finance Approver | View Cash Advance | Project ( Non-Outstation )</small></h1>
        <div class="panel panel" id="proejctNonOutsiteJs">
            ...
            <div class="row p-2">
                ...
                {{-- <div class="col d-flex justify-content-end">
                    ...
                    <a class="btn btn-lime" id="f_approver_button1" data-id="{{ $ca->id }}" style="color: black" type="submit"> Approve</a>
                    @endif 
                </div> --}}
            {{-- </div>
        </div>
