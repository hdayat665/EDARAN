...
@section('content')
    <div id="content" class="app-content">
        ...
        <!-- END breadcrumb -->
        <!-- BEGIN page-header -->
        <h1 class="page-header">eClaim | Cash Advance Approval | Finance Recommender</h1>
        <div class="panel panel" id="financeRecommenderCaJs">
                ...
                <div class="form-control">
                    ...
                    <div class="form-control">
                                ...
                                <div class="row">
                                    <div class="col d-flex justify-content-start">
                                        <ul class="nav nav-pills">
                                            ...
                                            <li class="nav-item">
                                                <a href="#default-tab-2" data-bs-toggle="tab" class="nav-link ">Recommend</a>
                                            </li>
                                            <li class="nav-item">
                        ...
                        <div class="tab-content panel p-3 rounded">
                            @include('pages.eclaim.claimApproval.cashAdvance.finance.recommender.tab1')
                            @include('pages.eclaim.claimApproval.cashAdvance.finance.recommender.tab2')
                            @include('pages.eclaim.claimApproval.cashAdvance.finance.recommender.tab3')
                            @include('pages.eclaim.claimApproval.cashAdvance.finance.recommender.tab4')
                            @include('pages.eclaim.claimApproval.cashAdvance.finance.recommender.tab5')
                        </div>
