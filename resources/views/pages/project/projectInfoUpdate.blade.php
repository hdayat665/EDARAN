<div class="tab-pane fade active show" id="tab1">
    ...
    <div class="panel-body">
        <form id="editProjectInfoForm">
                ...
                <div class="col-md-4">
                    <select class="form-select" name="customer_id">
                        ...
                        @foreach ($customers as $customer)
                            <option value="{{$customer->id}}" {{($project->customer_id == $customer->id) ? 'selected="selected"' : ''}}">{{$customer->customer_name}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-4">
            ...
            <div class="row mb-15px">
                <div class="col-md-4">
                    <input type="number" class="form-control mb-5px" name="contract_value" value="{{$project->contract_value ?? ''}}" />
                </div>
                <div class="col-md-4">
                    <select class="form-select" name="contract_type">
                        ...
                        @foreach ($ContractType as $key => $value )
                            <option value="{{$key}}" {{($key == $project->contract_type) ? 'selected="selected"' : ''}} >{{$value}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-4">
                    <select class="form-select" name="financial_year" >
                        <option  label="Please Choose "></option>
                        <?php $FinancialYear = getFinancialYear() ?>
                        @foreach ($FinancialYear as $key => $value )
                            <option value="{{$key}}" {{($key == $project->financial_year) ? 'selected="selected"' : ''}} >{{$value}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="row mb-15px">
                <div class="col-md-4">
                    <input type="text" class="form-control" name="LOA_date" value="{{$project->LOA_date ?? ''}}" id="datepicker-loa" placeholder="dd/mm/yyyy" />
                </div>
                <div class="col-md-4">
                    <input type="text" class="form-control" name="contract_start_date" value="{{$project->contract_start_date ?? ''}}" id="datepicker-start" placeholder="dd/mm/yyyy" />
                </div>
                <div class="col-md-4">
                    <input type="text" class="form-control" name="contract_end_date" value="{{$project->contract_end_date ?? ''}}" id="datepicker-end" placeholder="dd/mm/yyyy" />
                </div>
            </div>
            <div class="row">
            ...
            <div class="row mb-15px">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" id="datepicker-warstart" name="warranty_start_date" value="{{$project->warranty_start_date ?? ''}}" placeholder="dd/mm/yyyy" />
                </div>
            </div>
            <div class="row">
            ...
            <div class="row mb-15px">
                <div class="col-md-4">
                    <input type="text" class="form-control" id="datepicker-warend" name="warranty_end_date" value="{{$project->warranty_end_date ?? ''}}" placeholder="dd/mm/yyyy" />
                </div>
                <div class="col-md-4">
                    <input type="number" class="form-control" name="bank_guarantee_amount" value="{{$project->bank_guarantee_amount ?? ''}}"/>
                </div>
                <div class="col-md-4">
                    <input type="text" class="form-control" name="bank_guarantee_expiry_date" value="{{$project->bank_guarantee_expiry_date ?? ''}}" id="datepicker-bankexpiry" placeholder="dd/mm/yyyy" />
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-4">
                    <select class="form-select" name="status">
                        ...
                        @foreach ($status as $key => $value )
                            <option value="{{$key}}" {{($key == $project->status) ? 'selected="selected"' : ''}} >{{$value}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
