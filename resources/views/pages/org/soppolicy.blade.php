...
<div id="content" class="app-content">
    ...
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">General Information  <small>| Policy & SOP</small> </h1>
                            ...
                            <tbody>
                                @if ($policys)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$policy->policy}}</td>
                                        <td>{{$policy->desc}}</td>
                                        <td><a href="/storage/{{ $policy->file }}" target="_blank">{{ $policy->file }}</a></td>
                        ...
                        <tbody>
                            @if ($SOPs)
                                ...
                                <tr>
                                    ...
                                    <td>{{$SOP->SOPName}}</td>
                                    <td>{{$SOP->desc}}</td>
                                    <td><a href="/storage/{{ $SOP->file }}" target="_blank">{{ $SOP->file }}</a></td>
                                    <td>{{$SOP->addedBy}}</td>
