                ...
                <form id="addEmpForm">
                    <div class="card-body">
                        ...
                        <div class="row p-2">
                            ...
                            <select class="form-select" name="department" id="departmentHide">
                        ...
                        <div class="row p-2">
                            ...
                            <select class="form-select" name="unit" id="unitHide">
                                <?php $Units = getUnit() ?>
                                <option value="0" label="Please Choose "></option>
                        ...
                        <div class="row p-2">
                            ...
                            <select class="form-select" name="branch" id="branchHide">
                        ...
                        <div class="row p-2">
                            ...
                            <input type="text" name="joinedDate" value="{{$employment->joinedDate ?? ''}}" id="datepicker-joindate" class="form-control" placeholder="YYYY-MM-DD" aria-describedby="address-2">
                        </div>
                        <div class="row p-2">
                        ...
                        <div class="row p-2">
                            <div class="col-sm-6">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input partCheck2" value="on" name="supervisor" {{ ($employment->supervisor == 'on' ? 'checked' : '') }} type="checkbox" id="supervisor">
                                    <label class="form-label" for="supervisor">
                                        Supervisor
                                    </label>
                                    <div class="form-text">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="number" id="" name="COR"  value="{{$employment->COR ?? ''}}" class="form-control" aria-describedby="employee-id">
