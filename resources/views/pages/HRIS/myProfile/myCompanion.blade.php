                        ...
                        <div class="row p-2">
                            ...
                            <div class="col-sm-6">
                                <div class="form-check form-switch">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="mainCompanion" id="set-main" value="on">
                    ...
                    <div id="addressPddrofile">
                        ...
                        <div class="row p-2">
                            <div class="col-sm-6">
                                ...
                                <input type="text" id="designationmc" name="designation" class="form-control" placeholder="DESIGNATION" style="text-transform:uppercase" readonly>
                        ...
                        <div class="row p-2">
                            <div class="col-sm-6">
                                <label for="city" class="form-label">City*</label>
                                <select class="form-select" name="cityE" value="{{ $companion->city ?? '' }}" id="cityEmc" style="text-transform: uppercase;">
                                    <option type="text" value="" label="" selected="selected">PLEASE CHOOSE</option>
                                    @foreach($city->sortBy('name') as $cty)
                                        <option value="{{ $cty->name }}" {{ old('name') == $cty->name ? 'selected' : '' }}>{{ $cty->name }}</option>
                                    @endforeach
                            ...
                            <div class="col-sm-6">
                                <label for="postcode" class="form-label">Postcode*</label>
                                <select class="form-select" name="postcodeE" value="{{ $companion->postcode ?? '' }}" id="postcodeEmc" style="text-transform: uppercase;">
                                    <option type="text" value="" label="" selected="selected">Please Choose</option>
                                    @foreach($postcode->sortBy('postcode') as $pc)
                                        <option value="{{ $pc->postcode }}" {{ old('postcode') == $pc->postcode ? 'selected' : '' }}>{{ $pc->postcode }}</option>
                                    @endforeach
                        ...
                        <div class="accordion-body bg-white">
                            <form id="updateCompanionForm{{$no}}">
                                <div class="row p-2">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" {{ ($companion->mainCompanion ?? '') ? 'checked' : '' }} name="mainCompanion" value="{{ $companion->mainCompanion ?? '' }}" type="checkbox" role="switch" id="maincompanioncheck{{$companion->id}}">
                                            <label class="form-check-label" for="set-main">Set as Main Companion</label>
                                            <input type="hidden" name="id" value="{{$companion->id}}" id="idInput{{$companion->id}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row p-2">
