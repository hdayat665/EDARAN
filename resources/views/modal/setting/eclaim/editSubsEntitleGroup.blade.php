<div class="modal fade" id="editSubsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <form id="addUpdateForm">
                ...
                <div class="modal-body">
                    <div class="row mb-3">
                        <label for="subsistence allowance" class="col-sm-2 col-form-label">Subsistence
                            Allowance</label><br>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="area_name" name="area_name" placeholder="" readonly>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="value" id="valuesubsistence" placeholder="value">
                ...
                <div class="modal-footer">
                    ...
                    <div class="UpdateSubs">
                        <button type="submit" id="UpdateSubs" class="btn btn-primary">Update</button>
                    </div>
