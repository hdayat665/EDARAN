        ...
        <form id="addUpdateClaimCatForm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="claim_catagory" name="claim_catagory" placeholder="" readonly>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="claim_value" id="valueclaim" placeholder="value">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="UpdateClaimCatButton" class="btn btn-primary">Update</button>
