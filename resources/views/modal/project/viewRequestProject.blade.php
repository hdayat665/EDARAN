<div class="modal fade" id="viewRequestProjectModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <textarea class="form-control" readonly rows="5" style="text-transform: uppercase;" placeholder="Reason"></textarea>
                        </div>
                    </div>
                </form>
            </div>
