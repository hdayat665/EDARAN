        ...
        <div class="modal-content">
            ...
            <form id="rejectForm">
                <div class="modal-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            {{-- <input type="text" id="rejectId" value="{{ $ca->id }}"> --}}
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="rejectButton" data-id="{{ $ca->id }}" class="btn btn-primary">Save</button>
                </div>
            </form>
        </div>
    </div>
            ...
            <form id="amendForm">
                <div class="modal-body">
                    <div class="row mb-3">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">State reason</label><br>
                        <div class="col-sm-10">
                            {{-- <input type="text" value="{{ $ca->id }}" id="amendId"> --}}
                            <textarea class="form-control" name="remark" id="exampleFormControlTextarea1" rows="3" placeholder="input reason"></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" id="amendButton" data-id="{{ $ca->id }}" class="btn btn-primary">Save</button>
                </div>
            </form>
        </div>
    </div>
