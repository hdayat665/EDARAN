                            ...
                            <table id="" class="table table-striped table-bordered align-middle">
                                <thead>
                                    <tr>
                                        ...
                                        <th id="file_upload" class="text-nowrap">File Name</th>
                                        <th class="text-nowrap">Description</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <div class="form-control">
                                            ...
                                            <div class="row p-2">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="number" name="hotel_value" class="form-control" id="hotel" />
                                                </div>
                            ...
                            <div class="">
                                <table id="" class="table table-striped table-bordered align-middle">
                                    <thead>
                                        <tr>
                                            <th class="text-nowrap">No</th>
                                            <th id="file_upload1" class="text-nowrap">File Name</th>
                                            <th class="text-nowrap">Description</th>
                                        </tr>
                                    </thead>
                                    <tbody>
            ...
            <form id="updateOtherMtc">
                <div class="">
                    <div class="row p-2">
                        ...
                        <div class="col-md-8">
                            <input readonly type="text" class="form-control" id="claim_category">
                        </div>
                    </div>
                    <div class="row p-2">
                        <div class="col-md-4">
