                            ...
                            <table id="" class="table table-striped table-bordered align-middle">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-nowrap" id="file_upload">File Name</th>
                                        <th class="text-nowrap">Description</th>
                                    </tr>
                                </thead>
                                <tbody>
                                ...
                                <div class="col-md-6">
                                    <div class="form-control">
                                            ...
                                            <div class="row p-2">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="number" class="form-control" id="hotel" />
                                                </div>
                                            ...
                                            <div class="row p-2">
                                                ...
                                                <div class="col-md-3">
                                                    <input readonly type="text" class="form-control" value="" id="total">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row p-2">
                                                <div class="col md-3">
                                                    ...
                                                    <label for="file" id="file_upload1"></label>
                                                    <br>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="">
                                <table id="" class="table table-striped table-bordered align-middle">
                                    <thead>
                                        <tr>
                                            <th class="text-nowrap">No</th>
                                            <th class="text-nowrap" id="file_upload1">File Name</th>
                                            <th class="text-nowrap">Description</th>
                                        </tr>
                                    </thead>
                                    <tbody>
