<div class="modal fade" id="modaleditaddress" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                    ...
                    <input type="hidden" id="id1" name="id">
                        ...
                        <div class="row p-2">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select class="form-select" name="postcode" id="postcodeEdit" style="text-transform: uppercase;">
                        ...
                        <div class="row p-2">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select class="form-select" name="city" id="cityEdit" style="text-transform: uppercase;">
                                    <option type="text" value="" label="" selected="selected">Please Choose</option>
            ...
            <button class="btn btn-primary" id="saveAddressDetailsBtn">Update</button>
            </div>
        </div>
    </div>
</div>
