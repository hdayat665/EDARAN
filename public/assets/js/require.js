 ...
 (function(ga) {
         ...
         da.prototype = {
             ...
             fetch: function() {
                 if (!this.fetched) {
                     ...
                     var a = this.map;
                     if (this.shim) l.makeRequire(this.map, { enableBuildCallback: !0 })(this.shim.deps || [], z(this, function() { return a.prefix ? this.callPlugin() : this.load() }));
                 ...
                 if (this.enabled && !this.enabling) {
                     ...
                     if (!this.inited) x(l.defQueueMap, c) || this.fetch();
                         ...
                         if (1 > this.depCount && !this.defined) {
                             if (K(k)) {
                                 if (this.events.error && this.map.isDefine || g.onError !== ha) try { h = l.execCb(c, k, b, h) } catch (d) { a = d } else h = l.execCb(c, k, b, h);
             ...
             callPlugin: function() {
                 ...
                 w(d, "defined", z(this, function(h) {
                     ...
                     if (this.map.unnormalized) {
                         if (h.normalize && (M = h.normalize(M, function(a) { return c(a, r, !0) }) || ""), f = q(a.prefix + "!" + M, this.map.parentMap), w(f, "defined", z(this, function(a) {
     ...
     if ("undefined" === typeof define) {
         ...
         g.createNode = function(b, c, d) {
             c = b.xhtml ? document.createElementNS("https://www.w3.org/1999/xhtml", "html:script") : document.createElement("script");
         ...
         g.load = function(b, c, d) {
             ...
             if (ja) try { setTimeout(function() {}, 0), importScripts(d), b.completeLoad(c) } catch (q) { b.onError(F("importscripts", "importScripts failed for " + c + " at " + d, q, [c])) }
         };
